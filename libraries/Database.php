...
class Database
{
    ...
    public function __construct()
    {
        ...
        $this->link = mysqli_connect("sql207.byethost11.com", "b11_37613992", "Anhduy123", "b11_37613992_webtrasua");
        if (!$this->link) {
    ...
    public function calculateTotalAmount($cartItems)
    {
        ...
        foreach ($cartItems as $item) {
            ...
            if ($product) {
                $total += $product['price'] * intval($item['soluong']); // Nếu 'số lượng' có dấu cách, hãy dùng `số lượng`
            }
        }
        return $total;
    }
